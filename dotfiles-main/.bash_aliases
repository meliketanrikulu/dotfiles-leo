...
alias plug="cd ~/files/start_scripts/scripts && ./localization_error_plugin.sh && cd ~/"
alias joy="cd ~/files/start_scripts/scripts/joystick_scripts && ./joy_start.sh && cd ~/"
alias aw="cd ~/files/start_scripts/scripts && ./aw_launch.sh && cd ~/"
alias vcu="cd ~/files/start_scripts/scripts && ./vcu_driver.sh && cd ~/"
alias cont="cd ~/files/start_scripts/scripts && ./pointcloud_container.sh && cd ~/"
alias rtk="cd ~/files/start_scripts/scripts && ./ntrip_client.sh && cd ~/"
alias start="cd ~/files/start_scripts/scripts && ./start.sh && cd ~/"
